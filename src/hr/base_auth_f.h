...
class base_auth_f : public wxDialog 
{
	...
	public:
		wxButton* cancel_btn;
		base_auth_f( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("auth"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxCAPTION|wxTAB_TRAVERSAL|wxWANTS_CHARS, const wxString& name = wxT("auth_f") );
		~base_auth_f();
